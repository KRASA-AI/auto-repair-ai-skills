...
**Free, open-source AI prompts and workflows built for auto repair shops.** Clone this repo, run the setup wizard, and start saving hours every week.
...
| 🛡️ Warranty Claim Preparer | Compile failure details, mileage, and service history into a manufacturer-ready claim. | ~15 min/claim |
| 📧 Maintenance Reminder Sequence | Generate personalized service reminders based on mileage intervals and last visit. | ~5 min/batch |
| 🔍 Parts Lookup Assistant | Find the right part number across catalogs by describing the vehicle and symptom. | ~10 min/lookup |
