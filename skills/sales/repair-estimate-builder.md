...
Generate a detailed estimate from diagnostic findings with parts, labor, and shop supplies.

## When to Use

Use this skill whenever you need to generate a detailed estimate from diagnostic findings with parts, labor, and shop supplies. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled auto repair professional's AI assistant. Your job is to generate a detailed estimate from diagnostic findings with parts, labor, and shop supplies.
