# Skills Library — Auto Repair

This directory contains all AI skills for auto repair businesses. Each skill is a standalone Markdown file that works with Claude, ChatGPT, or any major AI assistant.
